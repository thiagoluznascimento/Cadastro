<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <!-- titration -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="titration" value="{{ __('Titulação') }}" />
            <x-jet-input id="titration" type="text" class="mt-1 block w-full" wire:model.defer="state.titration" autocomplete="titration" />
            <x-jet-input-error for="titration" class="mt-2" />
        </div>
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="rg" type="number" class="mt-1 block w-full" wire:model.defer="state.rg" autocomplete="rg" />
